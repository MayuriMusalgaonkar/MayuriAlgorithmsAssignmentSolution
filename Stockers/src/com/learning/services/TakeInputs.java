...
public class TakeInputs {
		...
		public static void getInputs(int noOfCompanies, Scanner sc, int choice) {
			double currentStockPriceArr[] =  new double[noOfCompanies]; 
			boolean stockPriccestatusArr[] =  new boolean[noOfCompanies]; 
			SortStockPrice sort = new SortStockPrice();
			/*
			 * SearchStockPrice search = new SearchStockPrice(); StockStatus stock = new
			 * StockStatus();
			 */
			...
			do {
				...
				switch(choice) {
					case 1:
						//1. Display the companies stock prices in ascending order
						// Used the Merge sort for ascending order and status is kept as false
					...
					case 2:
						//2. Display the companies stock prices in descending order
						// Used the Merge sort for descending order and status is kept as true
					...
					case 5:
						...
						int searchElement = SearchStockPrice.binarySearchImplementation(currentStockPriceArr, 0, currentStockPriceArr.length-1, key);
